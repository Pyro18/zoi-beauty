                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block"
                                ...
                                <img src="https://i.imgur.com/Xlef5Xj.jpg" alt="register form" class="img-fluid"
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form id="registerForm">
                                        <div id="parte1">
                                            ...
                                            <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Crea il tuo
                                                account</h5>
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div data-mdb-input-init class="form-outline mb-4">
                                                        ...
                                                        <input type="text" id="cognomeInput"
                                                            class="form-control form-control-lg" name="cognome" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="pt-1 mb-4 d-flex justify-content-between">
                                                <button id="avanti" type="button"
                                                    class="btn btn-dark btn-lg">Avanti</button>
                                                <div class="d-flex justify-content-between align-items-center mb-4">
                                                    <p class="mb-0" style="color: #393f81;">Hai già un account? <a
                                                            href="/login" style="color: #393f81;">Accedi qui!</a></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="parte2" style="display: none;">
                                            ...
                                            <div class="col-md-12">
                                                <div data-mdb-input-init class="form-outline mb-4">
                                                    ...
                                                    <input type="text" id="telefonoInput"
                                                        class="form-control form-control-lg" name="telefono" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div data-mdb-input-init class="form-outline mb-4">
                                                        <label class="form-label" for="confirmPasswordInput">Conferma
                                                            Password</label>
                                            ...
                                            <div class="pt-1 mb-4 d-flex justify-content-between">
                                                <button data-mdb-button-init data-mdb-ripple-init
                                                    class="btn btn-dark btn-lg" type="submit">Registrati</button>
                                                <button id="indietro" type="button"
                                                    class="btn btn-dark btn-lg">Indietro</button>
                                                <div class="d-flex justify-content-between align-items-center mb-4">
                                                    <p class="mb-0" style="color: #393f81;">Hai già un account? <a
                                                            href="/login" style="color: #393f81;">Accedi qui!</a></p>
                                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="messageModalLabel">ERRORE!!</h5>
