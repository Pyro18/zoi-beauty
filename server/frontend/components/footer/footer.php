...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/navbar_footer/footer.css">
    ...
    <footer class="py-5">
        <div class="row">
            ...
            <div class="col">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Sabato: 10:00 - 18:00</a></li>
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
            ...
            <ul class="list-unstyled d-flex">
                ...
                <li class="ms-3"><a class="link-body-emphasis" href="#"><i class="fa-brands fa-tiktok fa-xl"></i></a></li>
            </ul>
        </div>
    </footer>
</div>
